...
public class SpAdapter extends RecyclerView.Adapter<SpAdapter.MyViewHolder> {
    ...
    public SpAdapter(Context context, List<Sanpham> array) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View item = LayoutInflater.from(parent.getContext()).inflate(R.layout.itemsanpham,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.txtgia.setText(decimalFormat.format(Double.parseDouble(sanpham.getGia()))+"đ");
        Glide.with(context).load(sanpham.getUrlanh()).into(holder.imganhsp);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            imganhsp = itemView.findViewById(R.id.item_imagesp);
